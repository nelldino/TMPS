...
//        System.out.println("models.Book with this title already exists.");
//        return 0;
//    }
//       //if the ISBN of the books matches
//        if (Objects.equals(b1.ISBN, b2.ISBN)){
//            System.out.println("models.Book with this ISBN already exists.");
//            return 0;
//        }
//        return 1;
//    }
...
//                versionType = ((PrintedBook) book).getVersionType();
//                System.out.println(
//                        theBooks[i].ISBN + "\t\t"
//                                + theBooks[i].title + "\t\t"
//                                + theBooks[i].author + "\t\t"
...
//
//    //METHOD 7
//    //To search if the book is available or not
//
